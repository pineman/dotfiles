...
# curl-impersonate
curl -Lo /tmp/curl-impersonate.tar.gz https://github.com/lwthiker/curl-impersonate/releases/download/v1.4.4/curl-impersonate-v1.4.4.arm64-macos.tar.gz
tar -xzf /tmp/curl-impersonate.tar.gz -C ~/.local/bin/
xattr -d com.apple.quarantine ~/.local/bin/curl-impersonate
