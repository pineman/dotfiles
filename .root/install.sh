...
# Arch Linux install script for cronos wsl
# git clone https://github.com/pineman/dotfiles /dotfiles
# cd /dotfiles
# git checkout wsl
# .root/install stage1
...
stage1() {
  ...
  pacman --noconfirm -Syu base-devel vim sudo git fd ccache openssh
  stage2
}
...
stage2() {
  ...
  sudo -u pineman -i /dotfiles/.root/install.sh stage3
}
...
system-files() {
  ...
  cp settings.json /mnt/c/Users/pineman/AppData/Local/Packages/Microsoft.WindowsTerminal_8wekyb3d8bbwe/LocalState/
  cp ~/.config/alacritty/alacritty.yml /mnt/c/Users/pineman/AppData/Roaming/alacritty/
}
