class HtopVim < Formula
  ...
  def install
    system "curl -OL 'https://aur.archlinux.org/cgit/aur.git/plain/vim-keybindings.patch?h=htop-vim&id=6c1d9b5ca66d6fade8727e856290cd71e635a129'"
    system "patch -N < vim-keybindings.patch"
    system "./autogen.sh"
    args = ["--prefix=#{prefix}"]
